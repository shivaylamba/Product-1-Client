			...
			<div className="row">
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ul className="breadcrumbs">
						<li className="breadcrumbs-item">
							<a href="index.html">Home<i className="puzzle-icon fal fa-angle-double-right"></i></a>
						</li>
					...
					<h1 className="page-title text-white">How XtremeWorkers works for you</h1>
				</div>
				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt100">
					<header className="crumina-module crumina-heading heading--h2 heading--with-decoration heading--inline text-white mb-5">
						<h2 className="heading-title">We connect employers with professionals & Small Workers</h2>
						<div className="heading-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
					</header>
				</div>
			...
			<div className="row mb60">
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<header className="crumina-module crumina-heading heading--h2 heading--with-decoration decoration--yellow-theme heading--inline mb-0">
						<h2 className="heading-title">Find your Xtreme job in a few clicks</h2>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4 mb-md-0">
					<div className="crumina-module crumina-info-box info-box--border-top h-100">
						...
						<div className="info-box-thumb">
							<a href="02_how_it_works.html#" className="h4 info-box-title" data-toggle="modal" data-target="#signupModal">Create an account</a>
				...
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4 mb-md-0">
					<div className="crumina-module crumina-info-box info-box--border-top h-100">
						...
						<div className="info-box-thumb">
							<a href="11_submit_resume.html" className="h4 info-box-title">Update your profile/Add your resume</a>
							<svg className="puzzle-icon" width="100" height="100">
				...
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-0">
					<div className="crumina-module crumina-info-box info-box--border-top h-100">
						...
						<div className="info-box-thumb">
							<a href="11_submit_resume.html" className="h4 info-box-title">Get a job</a>
							<svg className="puzzle-icon" width="100" height="100">
			...
			<div className="row mb60">
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<header className="crumina-module crumina-heading heading--h2 heading--with-decoration decoration--red-theme heading--inline mb-0">
						<h2 className="heading-title">Find a XtremeWorker</h2>
						<div className="heading-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
					</header>
				</div>
			</div>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4 mb-md-0">
					<div className="crumina-module crumina-info-box info-box--standard">
						...
						<div className="info-box-content">
							<a href="02_how_it_works.html" className="h3 info-box-title" data-toggle="modal" data-target="#signupModal">Create an account</a>
						...
						<div className="info-box-thumb">
							<svg className="puzzle-icon" width="160" height="160">
				...
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4 mb-md-0">
					<div className="crumina-module crumina-info-box info-box--standard">
						...
						<div className="info-box-content">
							<a href="11_submit_resume.html" className="h3 info-box-title">Add your Job details</a>
							<p className="info-box-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
						</div>
				...
				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-0">
					<div className="crumina-module crumina-info-box info-box--standard">
						...
						<div className="info-box-content">
							<a href="03_job_lists_row_map.html" className="h3 info-box-title">Get Job Done</a>
							<p className="info-box-text">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						</div>
			...
			<div className="row align-items-center">
				<div className="col-lg-9 col-md-12 col-sm-12 col-xs-12 mb-4 mb-lg-0">
					<header className="crumina-module crumina-heading heading--h2 heading--with-decoration heading--inline decoration--dark-theme mb-0">
						<h2 className="heading-title">Get to started with XtremeWorkers right now!</h2>
						<div className="heading-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
					</header>
				</div>
